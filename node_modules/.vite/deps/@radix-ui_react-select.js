...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-EA5T5TRA.js";
import {
  VISUALLY_HIDDEN_STYLES,
  createCollection
} from "./chunk-WBTJXCMF.js";
import {
  DismissableLayer,
  Portal,
  composeEventHandlers,
  useControllableState
} from "./chunk-F42MT5NG.js";
import {
  useCallbackRef,
  useLayoutEffect2
...
function createSlot(ownerName) {
  ...
  const Slot22 = React4.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime3.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React4.isValidElement(newElement) ? React4.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var PopperAnchor = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime9.jsx)(Primitive2.div, { ...anchorProps, ref: composedRefs });
  }
);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React12.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime10.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  ...
  const Node2 = React13.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime11.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var SelectIcon = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Primitive3.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectContentImpl = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst = React15.useCallback(
      (candidates) => {
    ...
    return (0, import_jsx_runtime12.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime12.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime12.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectGroup = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime12.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime12.jsx)(Primitive3.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Primitive3.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
      (0, import_jsx_runtime12.jsx)(Primitive3.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime12.jsx)(Primitive3.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime12.jsx)(Primitive3.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);

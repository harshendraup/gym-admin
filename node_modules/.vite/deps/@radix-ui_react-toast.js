...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React4.useState(0);
  const isFocusedToastEscapeKeyDownRef = React4.useRef(false);
  const isClosePausedRef = React4.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime4.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime4.jsx)(
    ToastProviderProvider,
    {
      ...
      onToastAdd: React4.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React4.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React4.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React4.useRef(null);
    const tailFocusProxyRef = React4.useRef(null);
    ...
    const getSortedTabbableCandidates = React4.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React4.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React4.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const pointerStartRef = React4.useRef(null);
    const swipeDeltaRef = React4.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React4.useRef(0);
    const closeTimerRemainingTimeRef = React4.useRef(duration);
    const closeTimerRef = React4.useRef(0);
    ...
    const startTimer = React4.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React4.useMemo(() => {
    ...
    return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      (0, import_jsx_runtime4.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM2.createPortal(
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React4.useState(false);
  const [isAnnounced, setIsAnnounced] = React4.useState(false);
...
var ToastTitle = React4.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React4.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React4.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React4.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React4.forwardRef((props, forwardedRef) => {

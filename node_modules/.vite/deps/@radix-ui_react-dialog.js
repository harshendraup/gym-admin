...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React4.Children.map(children, (child) => (0, import_jsx_runtime4.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime4.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React4.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime4.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime4.jsx)(
        Primitive.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
